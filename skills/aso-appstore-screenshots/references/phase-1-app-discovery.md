...
Write `.aso/aso_app_context.md` per the format in `memory-schema.md`. Add a one-line entry to `.aso/MEMORY.md`.
...
USER_INPUT_GATE(questions=[{
    ...
    "multiSelect": False,
    "options": [
        {"label": "Lock", "description": "Write .aso/aso_app_context.md and proceed to Phase 2."},
